...
>[!info] Considerations for licensors:
...
> - Secure all rights necessary before applying our licenses so that the public can reuse the material as expected, and
...
>
>More considerations for licensors: [here](wiki.creativecommons.org/Considerations_for_licensors)

> [!info] Considerations for the public:
...
> 
> More considerations for the public: [here](wiki.creativecommons.org/Considerations_for_licensees)
